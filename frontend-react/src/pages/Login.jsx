            ...
            <div className="login-card glass-panel">
                ...
                <form className="login-form" onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="login-btn primary-gradient" disabled={isLoading} aria-busy={isLoading}>
                        {isLoading ? <Loader2 className="spinner" size={20} aria-hidden="true" style={{ marginRight: '0.5rem', color: 'inherit' }} /> : null}
                        {mode === 'login' ? 'Access Dashboard' : 'Create Account'}
                        {!isLoading ? <ArrowRight size={20} aria-hidden="true" style={{ marginLeft: '0.5rem' }} /> : null}
                    </button>
                </form>
