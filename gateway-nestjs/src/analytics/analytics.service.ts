...
export class AnalyticsService {
  ...
  async getFraudRate(userId: number) {
    ...
    // ⚡ Bolt Optimization: Execute independent count queries concurrently via Promise.all
    // This reduces network roundtrip latency by parallelizing database operations
    const [
