...
export class AnalyticsService {
  ...
  async getFraudRate(userId: number) {
    ...
    // 1. Fetch total transactions and fraud predictions concurrently for the user
    // Since Predictions maps to Transactions via transaction_id, we join to filter by user for fraud predictions.
    const [
