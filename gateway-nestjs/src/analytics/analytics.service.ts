...
export class AnalyticsService {
  ...
  async getFraudRate(userId: number) {
    ...
    // ⚡ Bolt: Execute independent Supabase queries concurrently using Promise.all
    // to eliminate sequential wait time and reduce latency.
    ...
    ] = await Promise.all([totalQuery, fraudQuery]);
