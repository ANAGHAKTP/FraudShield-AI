...
## 2024-05-18 - Avoid predict and predict_proba
**Learning:** Calling predict and predict_proba back-to-back causes double evaluation in scikit-learn models.
**Action:** Compute predict_proba once and derive the prediction manually.
