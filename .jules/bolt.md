...
## 2024-06-15 - [Concurrent Database Queries]
**Learning:** In Node.js backend services, sequential `await` calls for independent database queries (e.g., Supabase select counts) add unnecessary network latency.
